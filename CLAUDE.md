...
a write grant. Engineer/QA stages write app code plus `review.md`/`security.md`/`deploy.md` in their bound
...
| A bug where requirement + schema are already clear | engineer → `qa-engineer` | BA, SA, PM, test-planner | **Judgement retained; P3 insufficient** — all bug attempts failed the frozen oracle. |
