...
See `.claude/shared/agent-preamble.md` for shared operating guidance. Use `policies/architecture.md §7`, `policies/coding.md §5c`, `§20`, `§21`, `policies/documentation.md §1`, `§2`, `§4`, `§10`, `§12`, `policies/ux.md §17`, `§18`, `policies/agent-boundaries.md §6`, `policies/security.md §5d`, `policies/standards.md §8`, and `policies/git.md §5` when applicable. Read generated `.claude/shared/stack.md` for stack facts, never the engineering prompts.
