...
See `.claude/shared/agent-preamble.md` for shared operating guidance. Use `policies/architecture.md §7`, `policies/coding.md §5c`, `§12`, `§19`, `policies/agent-boundaries.md §6`, `§6a`, `policies/documentation.md §1`, `§10`, `policies/ux.md §17`, `§18`, and `policies/git.md §5` when applicable.
