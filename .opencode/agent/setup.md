...
See `.claude/shared/agent-preamble.md` for shared operating guidance. **T-WG5:** confirm workspace ↔ binding before writing. Use `policies/documentation.md §0`, `§2`, `policies/coding.md §9`, `policies/security.md §5a`, and `policies/git.md §5` when applicable.
